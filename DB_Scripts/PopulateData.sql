...
VALUES
    ...
    ('Gilmore Building', '3383 Gilmore Way', 'Burnaby', 'BC', 'V5G 4S1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
LOAD DATA LOCAL INFILE '<repo root>/DB_Scripts/Desks.csv' INTO TABLE resources
...
LOAD DATA LOCAL INFILE '<repo root>/DB_Scripts/Desks.csv' INTO TABLE desks
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r'
IGNORE 1 LINES
...
IGNORE 1 LINES
(@dummy1, @dummy2, @dummy3)
SET location_id = 2, resource_type = 'Desk', created_at = CURRENT_TIMESTAMP, updated_at = CURRENT_TIMESTAMP;
